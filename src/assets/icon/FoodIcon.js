...
export default function FoodIcon() {
  return (
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 252.755 252.755"
      // style="enable-background:new 0 0 252.755 252.755;"
    >
      <path
        fill="#BD9A3C"
        d="M152.876,71.463c-0.439-14.24-12.154-25.69-26.499-25.69s-26.06,11.45-26.499,25.69
      ...
      <path
        fill="#BD9A3C"
        d="M245.255,191.982H7.5c-4.143,0-7.5,3.357-7.5,7.5c0,4.143,3.357,7.5,7.5,7.5h237.755c4.143,0,7.5-3.357,7.5-7.5
